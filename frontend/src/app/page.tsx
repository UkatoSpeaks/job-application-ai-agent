    ...
    <div className="min-h-screen bg-slate-50 bg-hero-dots text-slate-900 flex flex-col font-sans selection:bg-emerald-500 selection:text-white">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 lg:px-8 py-10 space-y-16">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center pt-4">
          ...
          >
            {/* Badge: 600 weight */}
            <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-semibold shadow-xs">
              <Sparkles className="w-3.5 h-3.5 text-emerald-600" />
              <span>AI-Powered Job Application Assistant</span>
            </div>

            {/* Hero Heading: 64-72px desktop, 700 weight */}
            ...
            {/* Action Buttons: 500-600 weight */}
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <button
                onClick={() => handleOpenTool('job-agent')}
                className="bg-slate-900 hover:bg-slate-800 text-white font-semibold px-7 py-3.5 rounded-2xl text-[15px] transition-all duration-200 shadow-md hover:shadow-xl flex items-center space-x-2 hover:-translate-y-0.5"
              >
              ...
              <button
                ...
                className="bg-white hover:bg-slate-100 border border-slate-300 text-slate-700 font-medium px-6 py-3.5 rounded-2xl text-[15px] transition-all duration-200 flex items-center space-x-2 shadow-xs"
              >
          ...
          >
            <div className="bg-white border border-slate-200/90 rounded-3xl p-5 shadow-2xl space-y-4 relative overflow-hidden">
              ...
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                ...
                <div className="flex items-center space-x-2">
                  <button onClick={() => handleOpenTool()} className="bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-semibold px-3 py-1.5 rounded-lg flex items-center space-x-1 shadow-xs transition-colors">
              ...
              <div className="grid grid-cols-12 gap-4">
                ...
                <div className="col-span-4 space-y-1 pr-2 border-r border-slate-100 hidden sm:block">
                  <div className="flex items-center space-x-2 p-2 rounded-xl bg-emerald-50 text-emerald-700 font-semibold text-xs">
                ...
                <div className="col-span-12 sm:col-span-8 space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 font-normal">Welcome back, Alex 👋</p>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    ...
                    <div className="p-3 rounded-2xl bg-slate-50 border border-slate-200/80 flex flex-col items-center justify-center">
                      ...
                      <span className="text-[9px] text-slate-400 font-normal">Keep applying!</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-slate-400 font-normal">TechFlow</p>
                        </div>
                      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <div className="space-y-1">
                <h4 className="text-base font-bold text-slate-900">AI-Powered Matching</h4>
            ...
            >
              ...
              <div className="space-y-1">
                <h4 className="text-base font-bold text-slate-900">Resume Tailoring</h4>
                <p className="text-[13px] font-normal text-slate-500 leading-relaxed">
            ...
            >
              ...
              <div className="space-y-1">
                <h4 className="text-base font-bold text-slate-900">Cover Letter Generation</h4>
                <p className="text-[13px] font-normal text-slate-500 leading-relaxed">
            ...
            >
              ...
              <div className="space-y-1">
                <h4 className="text-base font-bold text-slate-900">Skill Gap Analysis</h4>
                <p className="text-[13px] font-normal text-slate-500 leading-relaxed">
        ...
        <section id="how-it-works" className="py-8 text-center space-y-10">
          <div className="space-y-3">
            <div className="inline-block px-3.5 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-semibold uppercase tracking-wider">
              HOW IT WORKS
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 tracking-tight">
              From job posting to application in minutes
            </h2>
            <p className="text-slate-500 text-[15px] font-normal max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative max-w-5xl mx-auto">
            ...
            >
              <span className="text-xs font-bold text-emerald-600 tracking-widest uppercase">01</span>
            ...
            <motion.div 
              ...
              className="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-4 text-center relative cursor-pointer"
            >
              <span className="text-xs font-bold text-purple-600 tracking-widest uppercase">02</span>
            ...
            <motion.div 
              ...
              className="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-4 text-center relative cursor-pointer"
            >
              <span className="text-xs font-bold text-emerald-600 tracking-widest uppercase">03</span>
              <div className="w-14 h-14 rounded-2xl bg-emerald-100 border border-emerald-200 flex items-center justify-center text-emerald-600 mx-auto">
        ...
        <section className="py-6 border-t border-slate-200 text-center space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-14 opacity-75 transition-all">
            <span className="text-lg font-semibold text-slate-700 tracking-tight">Google</span>
            <span className="text-lg font-semibold text-slate-700 tracking-tight">Microsoft</span>
            <span className="text-lg font-semibold text-slate-700 tracking-tight">amazon</span>
            <span className="text-lg font-semibold text-slate-700 tracking-tight">∞ Meta</span>
            <span className="text-lg font-semibold text-slate-700 tracking-tight"> Apple</span>
            <span className="text-lg font-semibold text-slate-700 tracking-tight">stripe</span>
            <span className="text-lg font-semibold text-slate-700 tracking-tight">Spotify</span>
          </div>
        </section>
      ...
      {/* Footer (14px, 400-500 weight) */}
      <footer className="border-t border-slate-200 bg-white py-8 text-center text-[14px] text-slate-500 font-normal mt-12">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-slate-900">Joblist AI Agent</span>
          </div>
          ...
          <div className="flex items-center space-x-4 text-slate-600 font-medium">
            <a href="#how-it-works" className="hover:text-emerald-600 transition-colors">Privacy Policy</a>
            <span>•</span>
            <a href="#how-it-works" className="hover:text-emerald-600 transition-colors">Terms of Service</a>
          </div>
        </div>
      </footer>
    </div>
