    ...
    <div className="min-h-screen bg-canvas text-ink font-sans selection:bg-purple-500 selection:text-white pb-20">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-6">
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-surface border border-line-soft space-y-5 shadow-sm">
            <h2 className="text-sm font-bold text-ink flex items-center gap-2 border-b border-line-soft pb-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-canvas border border-line-soft focus:border-purple-600 rounded-xl px-3.5 py-2 text-xs text-ink focus:outline-none"
                />
              </div>
          ...
          <div className="p-6 rounded-2xl bg-surface border border-line-soft space-y-4 shadow-sm">
            <h2 className="text-sm font-bold text-ink flex items-center gap-2 border-b border-line-soft pb-3">
              <FileText className="w-4 h-4 text-purple-600" />
              <span>Default Master Resume</span>
            </h2>

            <div className="p-4 rounded-xl bg-canvas border border-line-soft flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-xs font-bold text-ink">Anurag_Chaudhary_Resume.pdf</p>
                  <p className="text-[11px] text-muted font-medium">2.4 MB • Active Master Resume</p>
                </div>
              </div>

              <button
                type="button"
                className="px-3 py-1.5 rounded-lg border border-line-soft bg-surface text-xs font-semibold text-ink hover:bg-canvas transition-colors flex items-center space-x-1 cursor-pointer"
              >
            ...
            <div className="flex items-center justify-between pt-1">
              <div>
                <p className="text-xs font-semibold text-ink">Auto-use Default Resume</p>
                <p className="text-[11px] text-muted">Automatically select default resume when launching new job analysis</p>
              </div>
          ...
          <div className="p-6 rounded-2xl bg-surface border border-line-soft space-y-3 shadow-sm">
            <h2 className="text-sm font-bold text-ink flex items-center gap-2 border-b border-line-soft pb-3">
            ...
            <div className="flex items-center justify-between text-xs">
              <span className="text-muted font-medium">Backend API URL</span>
              <span className="font-mono text-ink bg-surface-2 px-2.5 py-1 rounded border border-line-soft font-semibold max-w-[280px] truncate" title={apiUrl}>
                {apiUrl}
              </span>
            </div>

            <div className="flex items-center justify-between text-xs pt-1">
              <span className="text-muted font-medium">Connection Status</span>
